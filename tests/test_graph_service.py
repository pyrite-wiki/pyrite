...
class TestGetGraph:
    def test_delegates_to_db(self, graph_svc, mock_db):
        ...
        result = graph_svc.get_graph(center="abc", kb_name="test", readable_kbs=UNSCOPED)
...
class TestGetBacklinks:
    def test_delegates_to_db(self, graph_svc, mock_db):
        ...
        result = graph_svc.get_backlinks("entry1", "mykb", readable_kbs=UNSCOPED)
    ...
    def test_with_limit_offset(self, graph_svc, mock_db):
        ...
        graph_svc.get_backlinks("e1", "kb", limit=10, offset=5, readable_kbs=UNSCOPED)
        mock_db.get_backlinks.assert_called_once_with(
...
class TestGetOutlinks:
    def test_delegates_to_db(self, graph_svc, mock_db):
        ...
        result = graph_svc.get_outlinks("entry1", "mykb", readable_kbs=UNSCOPED)
